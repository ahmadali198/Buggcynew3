...
const CheckoutPage = () => {
    ...
    return (
        <div className="min-h-screen bg-white py-10 px-4 sm:px-6 lg:px-8 font-inter flex justify-center items-start"> {/* Centered content horizontally */}
            <div className="max-w-6xl w-full bg-white shadow-none rounded-2xl p-6 sm:p-8 flex flex-col md:flex-row gap-8 md:gap-12"> {/* Increased max-w, adjusted padding and gap */}
                ...
                <div className="md:w-1/2 w-full space-y-6">
                    ...
                    <form className="space-y-5"> {/* Adjusted space-y */}
                        <div>
                            ...
                            <input type="text" id="fullName" className="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg shadow-none bg-white text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 text-left transition-colors" placeholder="John Doe" required />
                        </div>
                        <div>
                            ...
                            <input type="email" id="email" className="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg shadow-none bg-white text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 text-left transition-colors" placeholder="john.doe@example.com" required />
                        </div>
                        <div>
                            ...
                            <input type="text" id="address" className="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg shadow-none bg-white text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 text-left transition-colors" placeholder="123 Main St" required />
                        </div>
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4"> {/* Responsive grid for city/zip */}
                            <div>
                                ...
                                <input type="text" id="city" className="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg shadow-none bg-white text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 text-left transition-colors" placeholder="New York" required />
                            </div>
                            <div>
                                <label htmlFor="zipCode" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 text-left">Zip Code</label>
                                <input type="text" id="zipCode" className="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg shadow-none bg-white text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 text-left transition-colors" placeholder="10001" required />
                            </div>
                        </div>
                    </form>
                </div>
    ...
    className="inline-flex bg-green-600 text-white font-semibold py-2 px-4 border border-green-700 rounded-md shadow-none hover:bg-green-700 transition-all duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-105 focus:outline-none focus:ring-4 focus:ring-green-500 focus:ring-opacity-50 items-center space-x-2 mt-8 text-base text-left"
    ...
    {isProcessing ? (
        ...
        <span>Place Order</span>
            ...
            <Dialog open={showSuccessDialog} onOpenChange={setShowSuccessDialog}>
                <DialogContent className="sm:max-w-[425px] font-inter shadow-none"> {/* Added shadow-none */}
                    ...
                    <div className="flex justify-center mt-4">
                        <button
                            ...
                            className="bg-blue-600 text-white font-semibold py-2.5 px-6 rounded-lg shadow-none
                                     hover:bg-blue-700 transition duration-300" // Changed to shadow-none
                        >
                            Continue Shopping
                        </button>
                    </div>
