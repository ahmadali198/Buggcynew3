        ...
        <div className="min-h-screen bg-white py-10 px-4 sm:px-6 lg:px-8 font-inter flex justify-center items-start"> {/* Centered content horizontally */}
            <div className="max-w-6xl w-full bg-white shadow-none rounded-2xl p-6 sm:p-8 flex flex-col md:flex-row gap-8 md:gap-12"> {/* Increased max-w, adjusted padding and gap */}
                ...
                <div className="md:w-1/2 w-full space-y-6 text-gray-800 dark:text-gray-200">
                  ...
                  className="bg-green-600 text-white font-semibold py-2 px-4 rounded-full shadow-md hover:bg-green-700 transition-all duration-300 ease-in-out transform hover:-translate-y-0.5 hover:scale-105 focus:outline-none focus:ring-4 focus:ring-green-500 focus:ring-opacity-50 text-base text-left flex items-center justify-start gap-2 border border-green-700"
