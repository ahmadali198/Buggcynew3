  ...
  return (
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-10 px-4 sm:px-6 lg:px-8 font-inter">
      <div className="max-w-screen-xl mx-auto flex flex-col gap-8"> {/* Changed to flex-col and increased gap */}
        ...
        {cartItems.length === 0 ? (
          // Empty Cart State
          <div className="flex flex-col items-center justify-center py-16 bg-white dark:bg-gray-800 rounded-3xl shadow-xl px-4 text-center">
            <svg
          ...
          <div className="flex flex-col gap-8"> {/* Main flex container for stacking */}
            ...
            <div className="w-full space-y-4">
              {cartItems.map((item) => (
                <div
                  key={item.id}
                  className="flex flex-col sm:flex-row items-center justify-between bg-white dark:bg-gray-800 p-5 rounded-2xl shadow-md hover:shadow-lg transition-all duration-300 border border-gray-200 dark:border-gray-700"
                >
            ...
            <div className="w-full bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 border border-gray-200 dark:border-gray-700">
              ...
              <div className="flex flex-col gap-4">
                <button
                  ...
                  className="w-full bg-gradient-to-r from-green-500 to-green-600 text-white font-semibold py-3 rounded-full shadow-lg hover:from-green-600 hover:to-green-700 transition-all duration-300 transform hover:-translate-y-0.5 focus:outline-none focus:ring-4 focus:ring-green-500 focus:ring-opacity-50 text-lg"
                >
                  Proceed to Checkout
                </button>
                <button
                  onClick={clearCart}
                  className="w-full border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 font-semibold py-3 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors shadow-md focus:outline-none focus:ring-4 focus:ring-gray-400 focus:ring-opacity-50 text-lg"
                >
                  Clear Cart
                </button>
                <button
                  onClick={() => navigate("/")}
                  className="w-full bg-blue-600 text-white font-semibold py-3 rounded-full shadow-lg hover:bg-blue-700 transition-all duration-300 transform hover:-translate-y-0.5 focus:outline-none focus:ring-4 focus:ring-blue-500 focus:ring-opacity-50 text-lg"
                >
                  Continue Shopping
                </button>
              </div>
