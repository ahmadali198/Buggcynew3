...
const ProductDetailPage = () => {
    ...
    if (isLoading) {
        return (
            <div className="flex justify-center items-center h-screen bg-white text-gray-700 dark:text-gray-300 font-inter">
    ...
    if (error) {
        return (
            <div className="flex justify-center items-center h-screen bg-white text-red-600 dark:text-red-400 font-inter">
    ...
    return (
        <div className="min-h-screen bg-white py-10 px-4 sm:px-6 lg:px-8 flex items-center justify-center font-inter">
            <div className="max-w-5xl w-full bg-white shadow-none rounded-2xl overflow-hidden p-8 flex flex-col md:flex-row gap-10 items-start transform transition-all duration-300">
                {/* Product Image Section */}
                <div className="md:w-1/2 w-full flex justify-center items-center bg-white rounded-xl p-6 shadow-none">
                    <img
                        src={product.image}
                        alt={product.title}
                ...
                <div className="md:w-1/2 w-full space-y-6 text-gray-800 dark:text-gray-200 text-left">
                    ...
                    <button
                        ...
                        className="w-full md:w-auto bg-blue-600 text-white font-semibold py-3 px-8 rounded-full shadow-none hover:bg-blue-700 transition-all duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-105 focus:outline-none focus:ring-4 focus:ring-blue-500 focus:ring-opacity-50"
                    >
                        Add to Cart
                    </button>
                </div>
