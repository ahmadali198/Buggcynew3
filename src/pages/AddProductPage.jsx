// import React, { useState, useCallback, useMemo } from "react"; // Added useCallback, useMemo
...
//   // Memoize categories if they were potentially derived from props or other state
//   // In this case, it's a static array, so useMemo is not strictly necessary for performance
//   // but good for consistency if this array ever became dynamic or large.
...
//   // Memoize handleChange to prevent its recreation on every render
//   const handleChange = useCallback((e) => {
//     const { name, value } = e.target;
//     setFormData((prev) => ({ ...prev, [name]: value }));
//   }, []); // No dependencies as it only uses `setFormData`

//   // Memoize handleImageChange to prevent its recreation on every render
...
//   // Memoize handleSubmit to prevent its recreation on every render
//   // Dependencies: formData, navigate, createProduct, setShowSuccessPopup, setLoading, setError
...
//       setLoading(false);
//     }
//   }, [formData, navigate, createProduct, setShowSuccessPopup, setLoading, setError]);
//     // Added createProduct to dependencies: If createProduct comes from props or context,
//     // and might change, it should be a dependency. If it's a static import, it's stable.
//     // Assuming createProduct is stable due to static import, but including it for correctness.

//   return (
//     <div className="container px-4 py-8 max-w-2xl mt-2 font-inter">
//       <div className="bg-white dark:bg-gray-800 shadow-xl rounded-xl p-6 sm:p-8 border border-gray-200 dark:border-gray-700">
//         <h2 className="text-3xl font-extrabold text-gray-900 dark:text-white mb-6 text-left flex items-center space-x-3">
...
//                   type="file"
//                   accept="image/*"
//                   onChange={handleImageChange} // Using memoized handler
