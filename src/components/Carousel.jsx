...
const Carousel = () => {
    ...
    return (
        <div
            className="mt-2 relative w-full rounded-2xl overflow-hidden shadow-none transform transition-all duration-500 font-inter" // Changed shadow-2xl to shadow-none
            ...
            >
                {carouselItems.map((item, index) => (
                    <div key={index} className="w-full flex-shrink-0 relative">
                        ...
                        />
                        <div className="absolute inset-0 bg-white-to-t from-black/70 via-black/30 to-transparent"></div>
                                ...
                                {item.buttonText && item.scrollTo && (
                                    <button
                                        ...
                                        className="inline-block mt-6 px-6 py-3 text-base sm:px-8 sm:py-4 sm:text-lg bg-blue-600 text-white font-semibold rounded-full
                                                 shadow-none hover:bg-blue-700 transition-all duration-300 transform hover:-translate-y-1 hover:scale-105
                                                 focus:outline-none focus:ring-4 focus:ring-blue-500 focus:ring-opacity-50 animate-fade-in-up delay-400" // Changed shadow-lg to shadow-none
                                    >
                                        {item.buttonText}
                                    </button>
                                )}
